...
import { HomeDataState, HomeReducer, HomeSuccessAction } from "./home.types";
...
export const homeReducer: HomeReducer = (state: HomeDataState = initialHomeState, action: HomeSuccessAction) => {
	...
	switch (type) {
		...
		case HomeActionStateType.CREATE_TUTORIAL_SUCCESS: {
			// Wrap the keys in enum to evaluate their value before using them as keys in an object
			return { ...state, ...{ [HomeActionStateType.CREATE_TUTORIAL_SUCCESS]: payload } };
		}
		case HomeActionStateType.RETRIEVE_MANY_TUTORIALS_SUCCESS:
			return { ...state, ...{ [HomeActionStateType.RETRIEVE_MANY_TUTORIALS_SUCCESS]: payload } };
		case HomeActionStateType.RETRIEVE_TUTORIAL_SUCCESS:
			return { ...state, ...{ [HomeActionStateType.RETRIEVE_TUTORIAL_SUCCESS]: payload } };
		case HomeActionStateType.UPDATE_TUTORIAL_SUCCESS:
			return { ...state, ...{ [HomeActionStateType.UPDATE_TUTORIAL_SUCCESS]: payload } };
		case HomeActionStateType.DELETE_TUTORIAL_SUCCESS:
			return { ...state, ...{ [HomeActionStateType.DELETE_TUTORIAL_SUCCESS]: payload } };
		case HomeActionStateType.DELETE_MANY_TUTORIALS_SUCCESS:
			return { ...state, ...{ [HomeActionStateType.DELETE_MANY_TUTORIALS_SUCCESS]: payload } };
		default:
			return state;
	}
};
